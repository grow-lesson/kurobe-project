...
(function($) {
    $.fn.memoryGame = function() {
        ...
        function initializeGame() {
            ...
            gameContainer.html(createCardElements(shuffledValues));
            $(".game-message").hide();
            matchedPairs = 0;
            resetTurn();
        }
        ...
        // カードの要素を生成
        function createCardElements(shuffledValues) {
        ...
        gameContainer.on("click", ".card", function() {
            ...
            if (!firstCard) {
                ...
                if (firstCard.data("value") === secondCard.data("value")) {
                    setTimeout(() => {
                        firstCard.addClass("matched").find('.card-front').text("✔");
                        secondCard.addClass("matched").find('.card-front').text("✔");
                        resetTurn();

                        // ペアがそろった数をカウント
                        matchedPairs++;
                        if (matchedPairs === 8) {
                            $(".game-message").text("ゲームクリア！").fadeIn();
                        }
                    }, 500); // 0.5秒後に確認
                } else {
                    setTimeout(() => {
