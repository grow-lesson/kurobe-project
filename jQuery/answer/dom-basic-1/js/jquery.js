...
(function($) {
    $.fn.intermediateTasks = function() {
        // Task 1: テキストと色の切り替え
        $("#task1").click(function() {
            const isToggled = $(this).hasClass("toggled");
            $(this).toggleClass("toggled");
            $(this).text(isToggled ? "Task 1: テキストと色の切り替え" : "切り替えました!");
            $(this).css("background-color", isToggled ? "#6c757d" : "#e83e8c");
        });
        ...
        $("#task2").click(function() {
            ...
            const interval = setInterval(() => {
                count++;
                $(this).css("background-color", count % 2 === 0 ? "#6c757d" : "#28a745");
        ...
        $("#task4").click(function() {
            ...
            $(this).text(`ランダム文字列: ${randomText}`);
        });

        // Task 5: 各リストアイテムをクリックしたら、その順番を表示
        $("#task5").find("li").click(function() {
            const index = $(this).index() + 1;
            alert(`リストアイテムの位置: ${index}`);
        });

        // Task 6: 要素の追加と削除のアニメーション
        $("#task6").click(function() {
            if ($(".new-element").length === 0) {
                $(this).after('<div class="new-element">新しい要素が追加されました</div>');
                $(".new-element").hide().fadeIn(500);
            } else {
                $(".new-element").fadeOut(500, function() {
                    $(this).remove();
                });
            }
        });
